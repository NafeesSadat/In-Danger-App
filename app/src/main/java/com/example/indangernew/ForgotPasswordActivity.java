...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetPassword.setOnClickListener(view -> {
            ...
            if (txtEmail.isEmpty()) {
                Toast.makeText(ForgotPasswordActivity.this, "Enter your email to reset your password!", Toast.LENGTH_SHORT).show();
            }
            else if (!Patterns.EMAIL_ADDRESS.matcher(txtEmail).matches()) {
                Toast.makeText(ForgotPasswordActivity.this, "Please provide a valid Email Address", Toast.LENGTH_SHORT).show();
            }
            else {
                FirebaseAuth.getInstance().sendPasswordResetEmail(txtEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ForgotPasswordActivity.this, "Please provide your valid account Email Address", Toast.LENGTH_SHORT).show();
                        }
                    }
